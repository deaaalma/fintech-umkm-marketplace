...
<header class="px-8 lg:px-12 py-8 flex flex-col sm:flex-row justify-between items-center bg-[#F8FAFC]/50 backdrop-blur-xl sticky top-0 z-40 transition-all duration-300 border-b border-slate-100/50">
    ...
    <div class="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-6">
        <div class="relative hidden xl:block group transition-all duration-300">
            <input type="text" placeholder="Search data..." class="w-72 focus:w-80 pl-12 pr-6 py-3.5 bg-white/70 border border-slate-200 rounded-2xl text-xs font-bold focus:ring-[12px] focus:ring-[#0078B6]/10 focus:border-[#0078B6]/30 focus:bg-white transition-all duration-500 placeholder:text-slate-400 outline-none shadow-sm">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="w-12 h-12 bg-[#0077B6]/10 border-2 border-[#0077B6]/20 rounded-2xl flex items-center justify-center text-[#0077B6] font-black font-plus shadow-sm overflow-hidden group cursor-pointer hover:border-[#0077B6] transition-all">
                 <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=0077B6&color=fff" alt="Avatar" class="group-hover:scale-110 transition-transform">
            </div>
        </div>
    </div>
</header>