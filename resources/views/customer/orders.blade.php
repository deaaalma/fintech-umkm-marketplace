        ...
        <main class="pt-20">
            ...
            <div class="w-full bg-white border-b border-[#e5e5e5]">
                <div class="max-w-7xl mx-auto px-6 lg:px-8 py-12">
                    <h1 class="text-[40px] leading-tight font-normal text-[#064E3B] tracking-tight mb-2" style="font-weight: 400; font-family: 'Figtree', sans-serif;">Pesanan Saya</h1>
                ...
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div class="mb-8 overflow-x-auto">
                        <div class="flex gap-3 min-w-max">
                            ...
                            <button 
                                ...
                                :class="activeTab === '{{ $tab['id'] }}' ? 'bg-[#064E3B] text-white' : 'bg-white text-[#064E3B] hover:bg-gray-50'"
                                ...
                                <span>{{ $tab['label'] }}</span>
                                <span :class="activeTab === '{{ $tab['id'] }}' ? 'bg-white/20 text-white' : 'bg-[#064E3B]/10 text-[#064E3B]'" class="px-2 py-0.5 rounded-full text-xs font-semibold">{{ $tab['count'] }}</span>
                            </button>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="mb-8 flex flex-col md:flex-row gap-4">
                        ...
                        <button class="px-6 py-4 bg-white border border-[#e5e5e5] rounded-xl hover:bg-gray-50 transition-colors flex items-center gap-2" style="font-family: 'Figtree', sans-serif;">
                            ...
                            <span class="font-medium text-[#064E3B]">Filter Lainnya</span>
                        </button>
                    </div>
                        ...
                        <div class="bg-white rounded-3xl p-8 border border-[#e5e5e5] hover:shadow-md transition-all duration-300">
                            ...
                            <div class="flex items-start justify-between mb-6">
                                ...
                                <span class="px-4 py-2 rounded-full text-xs font-semibold whitespace-nowrap
                                    ...
                                    {{ $order['statusColor'] === 'red' ? 'bg-[#064E3B] text-white' : '' }}"
                                    style="font-family: 'Figtree', sans-serif;">
                                    {{ $order['status'] }}
                                </span>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <button class="flex-1 bg-[#167E6C] text-white px-6 py-4 rounded-xl text-base font-semibold hover:bg-[#064E3B] transition-all duration-200 hover:shadow-sm flex items-center justify-center gap-2" style="font-family: 'Figtree', sans-serif;">
                                    Review Pre-Invoice
                                ...
                                <button class="flex-1 bg-white border-2 border-[#e5e5e5] text-[#064E3B] px-6 py-4 rounded-xl text-base font-semibold hover:border-[#167E6C] hover:text-[#167E6C] transition-all duration-200 flex items-center justify-center gap-2" style="font-family: 'Figtree', sans-serif;">
                                    Beri Review
                                </button>
                                <button class="px-6 py-4 bg-white border-2 border-[#e5e5e5] text-[#064E3B] rounded-xl font-semibold hover:border-[#167E6C] hover:text-[#167E6C] transition-all duration-200" style="font-family: 'Figtree', sans-serif;">
                                    Lihat Detail
                                </button>
                                @else
                                <button class="flex-1 bg-white border-2 border-[#e5e5e5] text-[#064E3B] px-6 py-4 rounded-xl text-base font-semibold hover:border-[#167E6C] hover:text-[#167E6C] transition-all duration-200 flex items-center justify-center gap-2" style="font-family: 'Figtree', sans-serif;">
