...
<div class="space-y-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-[#000B44] p-8 rounded-[2rem] text-white shadow-2xl animate-fade-in-up" style="animation-delay: 0.1s">
            ...
            <div class="flex items-center gap-2 mt-auto"><span class="bg-teal-500/20 text-teal-400 text-[10px] font-black px-2 py-0.5 rounded-lg flex items-center gap-1 leading-none">12% <svg class="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd"></path></svg></span><span class="text-[10px] font-bold text-white/40 uppercase tracking-widest">Since last month</span></div>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl animate-fade-in-up" style="animation-delay: 0.3s">
            ...
            <div class="flex items-center gap-2 mt-auto"><span class="bg-blue-50 text-blue-600 text-[10px] font-black px-2 py-0.5 rounded-lg flex items-center gap-1 leading-none">/ 15 <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="3"><path d="M13 10V3L4 14h7v7l9-11h-7z" stroke-linecap="round" stroke-linejoin="round"></path></svg></span><span class="text-[10px] font-bold text-slate-300 uppercase tracking-widest">Resource Capacity</span></div>
        </div>
    </div>

    <div class="grid grid-cols-12 gap-8 items-start">
        <div class="col-span-12 xl:col-span-8 bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all font-plus shadow-sm">
