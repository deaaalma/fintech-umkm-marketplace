        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md">
                ...
                <form wire:submit="login" class="space-y-6" x-data="{ showPassword: false }">
                    ...
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Email or phone number</label>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input wire:model="form.remember" id="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300">
                            </div>
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm font-medium text-gray-600 hover:text-black" wire:navigate>
                                Forgot password?
                            </a>
                        @endif
                    </div>
                   ...
                   <div class="flex justify-center space-x-4">
                    ...
                    <p class="text-sm font-light text-center text-gray-500">
                        Don’t have an account? <a href="{{ route('register') }}" class="font-bold text-black hover:underline" wire:navigate>Sign Up</a>
                    </p>
                </form>
            </div>
        </div>
