...
<body class="font-sans antialiased bg-white">
    ...
    <div class="flex min-h-screen w-full">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
            <div class="w-full max-w-md py-8"> <h2 class="text-3xl font-bold text-gray-900 mb-2">Create your account</h2>
                ...
                <form wire:submit="register" class="space-y-5" x-data="{ showPassword: false }">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input wire:model="terms" id="terms" type="checkbox" class="w-5 h-5 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-black">
                        </div>
                        <label for="terms" class="ml-3 text-sm text-gray-500">
                            By creating an account means you agree to the <a href="#" class="font-bold text-gray-900 hover:underline">Terms and Conditions</a>, and our <a href="#" class="font-bold text-gray-900 hover:underline">Privacy Policy</a>
                        </label>
                    </div>
                    ...
                    <div class="relative flex items-center justify-center my-6">
                        ...
                        <span class="absolute bg-white px-3 text-gray-400 text-xs uppercase">or do it via other accounts</span>
                    </div>
                    ...
                    <div class="flex justify-center space-x-4">
                        ...
                        <a href="#" class="p-3 rounded-full border border-gray-200 hover:bg-gray-50 transition">
                            <svg class="w-6 h-6 text-black" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                        </a>
                    </div>
