<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <a href="{{ route('superadmin.dashboard.users') }}" wire:navigate class="metric-card group bg-white rounded-2xl border border-slate-300 animate-fade-in-up hover:border-[#0077B6] hover:scale-[1.01] transition-all duration-300 overflow-hidden shadow-sm" style="animation-delay: 0.08s">
            {{-- Top row: label + dots --}}
