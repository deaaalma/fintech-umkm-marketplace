...
<body class="font-sans antialiased bg-background text-foreground">
    <div class="min-h-screen">
        ...
        @include('templates.components.landing-page.navbar')
        @include('templates.components.landing-page.hero')
        @include('templates.components.landing-page.service')
        @include('templates.components.landing-page.process')
        @include('templates.components.landing-page.faq')
        @include('templates.components.landing-page.footer')
    </div>

    @include('templates.components.landing-page.scripts')
</body>
</html>