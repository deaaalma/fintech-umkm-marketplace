...
>
    ...
    >
        ...
        <div class="hidden lg:flex items-center gap-6">
            ...
            <a href="{{ route('register') }}" class="bg-[#000066] text-white px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-500 group flex items-center gap-0 hover:gap-4 border border-[#000066]/20 hover:bg-[#000066]/90 backdrop-blur-sm shadow-md" wire:navigate>
    ...
    >
        <div class="px-6 py-8 space-y-6">
            ...
            <div class="pt-6 border-t border-[#000066]/10 flex flex-col gap-4">
                 <a href="{{ route('login') }}" class="block w-full text-center text-[#000066]/70 font-medium hover:text-[#000066] transition-colors py-2 text-lg" style="font-family: 'Plus Jakarta Sans', sans-serif;">Masuk</a>
                <a href="{{ route('register') }}" class="w-full bg-[#000066] text-white px-6 py-4 rounded-2xl text-lg font-semibold hover:bg-[#000066]/90 transition-all duration-200 flex items-center justify-center gap-3 shadow-md" style="font-family: 'Plus Jakarta Sans', sans-serif;" wire:navigate>
                    <span>Daftar</span>
